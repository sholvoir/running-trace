...
import cn.micit.domain.LocationRepository;
import cn.micit.service.LocationService;
...
public class LocationServiceImpl implements LocationService {
    ...
    @Override
    public List<Location> saveRunningLocations(Iterable<Location> runningLocations) {
